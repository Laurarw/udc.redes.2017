				...
				<div class="row">
					...
					<div class="col-xlarge-8 col-medium-8">
						...
						<div class="page-content single-blog-content">
							<h3>El resultado de tu test es de <?php echo $v1; ?> puntos, por lo que eres:</h3>
							<blockquote><p>0-8 puntos (Persona nada creativa).</p></blockquote>
							<p>Tu imaginación brilla por su ausencia. Por ello, prefieres no complicarte mucho la vida y elegir aquellas opciones que ya en su momento te funcionaron. Si tú estás a gusto, esto no es un problema, pero si no es así, prueba a saltarte los convencionalismos de vez en cuando.</p>
							<blockquote><p>9-16 puntos (Persona algo creativa).</p></blockquote>
							<p>De vez en cuando decides arriesgar, y unas veces aciertas, y otras no. Es lo normal. Por eso, sigue así, sé genuino, y disfruta realmente con lo que a ti te gusta.</p>
							<blockquote><p>17-24 puntos (Persona creativa).</p></blockquote>
							<p>Eres una persona que crea su estilo, su moda, sus decisiones y forma de vivir. Ser creativo es un rasgo de personalidad excelente, pero ten cuidado y no olvides que en ocasiones es necesario adaptarse a circunstancias en las que se exige cumplir ciertos convencionalismos.</p>
					...
					<div class="col-xlarge-4 col-medium-4 post-sidebar right-sidebar">
						...
						<div class="sidebar-widget list-widget">
							<h3 class="font-reg">Categorias</h3>
							<ul class="font-reg">
